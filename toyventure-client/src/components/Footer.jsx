...
const Footer = () => {
  return (
    // Increased padding-top and padding-bottom for more space
      ...
      <div className="relative z-20 max-w-[1400px] mx-auto px-6 md:px-12">
        ...
        <div className="grid md:grid-cols-12 gap-12 pb-12">
          ...
          <div className="md:col-span-2 text-center md:text-left">
            ...
            <ul className="space-y-3 text-red-200/70 text-sm">
              {/* Corrected paths to match App.jsx routes */}
              <li className="hover:text-white transition"><Link to="/shipping">Shipping</Link></li>
              <li className="hover:text-white transition"><Link to="/returns">Returns</Link></li>
              <li className="hover:text-white transition"><Link to="/safety-standards">Safety</Link></li>
            </ul>
          </div>
          ...
          <div className="md:col-span-4 text-center md:text-left">
            ...
            <ul className="space-y-3 text-red-200/70 text-sm">
              ...
              <li className="hover:text-white transition"><Link to="/terms">Terms of Service</Link></li>
            </ul>
          </div>
